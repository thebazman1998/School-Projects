    ...
    while True:
        ...
        if p1 > 0:
            ...
            if not(crouching):
                if keys[p1l]:
                    if player.top > pHei:
                        if moveUp == True or punch or kick:
                            pass
                        else:
                            moveLeft = True
                            moveRight = False
        ...
        if p2 > 0:
            ...
            if not(crouching):
                if keys[p2l]:
                    if player2.top > pHei:
                        if move2Up == True or punch2 or kick2:
                            pass
                        else:
                            move2Left = True
                            move2Right = False
        ...
        if p1 > 0:
            ...
            if moveUp and player.top > 0:
                if player.top < 240:
                    ...
                    player.top -= 20
            if moveLeft and not(moveUp or punch or kick):
                if player.left > 0:
                    ...
                    moveLeft = False
                    moveRight = True
            if moveRight and not(moveUp or punch or kick):
        ...
        if p2 > 0:
            ...
            if move2Up and player2.top > 0:
                if player2.top < 240:
                    ...
                    player2.top -= 20
            if move2Left and not(move2Up or punch2 or kick2):
                if player2.left > 0:
            ...
            if move2Right:
                if not(move2Up or punch2 or kick2):
        ...
        if p1 > 0 and p2 > 0:
            if player.left > player2.right:        # P1 face right, P2 face left
                if player.bottom >= 700:
            ...
            elif player.right < player2.left:      # P1 face left, P2 face right
                if player.bottom >= 700:
                    if jumpCount > 20 and jumpCount < 28:
                        playerImage = pygame.image.load('Graphics/Cvs Asuka Jump Right/tmp-'+ str(jumpCount/2) + '.gif')
                        playerImage = pygame.transform.flip(playerImage,1,0)
