...
def calculatePayroll(hoursWorked, hoursOver, hourlyRate):
    ...
    overPay = hoursOver * hourlyRate
    totalPay = notOverPay + overPay
    
    return "Hours worked not overtime:", notOvertime, "/n Hours worked overtime:", hoursOver, "/n not overtime pay:", notOverPay, "/n Overtime pay:", overPay, "/n Total pay:", totalPay


print calculatePayroll(5, 3, 10.50)