...
def Bp_descHall(rug):
    ...
    if rug == 0:
        ...
        print "You look around the hall and see the door, a crystal chandelier, and rug half overturned, covering the hardwood floor."
        methods.Ib_wait(0.2)
        print
        methods.Ib_wait(0.2)
...
def Bp_playHall(): # Hallway Level
    ...
    while rugMove == 1 and chandelier == 0:
        ...
        if command == "break chandelier" or command == "use broomhandle, chandelier" or command == "use handle, chandelier" or command == "use broom, chandelier":
            print "\nYou rustle the chandelier with the long broomhandle,\nand a key falls onto the hardwood floor!\n"
