...
def songSelect():
    ...
    while not(done):
        ...
        title2 = font.render("WIP",4,(255,255,255))
        title3 = font.render("WIP",4,(255,255,255))
        
        location1 = (500,200,150,80)
        location2 = (500,350,150,80)
        location3 = (500,500,150,80)
...
def play(song, diff, bpm, maxBeat, name):
...
def main():
    diffSong = diffSelect()
    song = songSelect()
    numSong, bpm, maxBeat, nameSong = song[0], song[1], song[2], song[3]
    play(numSong,diffSong,bpm,maxBeat,nameSong)
