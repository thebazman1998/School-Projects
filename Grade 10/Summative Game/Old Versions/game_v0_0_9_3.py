...
def songSelect():
    ...
    while not(done):
        ...
        title2 = font.render("TBD",4,(255,255,255))
        title3 = font.render("TBD",4,(255,255,255))
...
def play(song, diff, bpm, maxBeat):
    ...
    toBePlayed, streaks = [], []
    notes, noteStreak, score, newScore = 0, 0, 0, 0
    lastHit = False
    ...
    pygame.display.set_caption("Playing song"+song)
...
def songEnd(score,highest,song):
    pass

def main():
    diffSong = diffSelect()
    song = songSelect()
    numSong, bpm, maxBeat = song[0], song[1], song[2]
    play(numSong,diffSong,bpm,maxBeat)
