...
def songEnd(score,highest,name,notesHit,notes,song,diff,bpm,maxBeat,speed):
    ...
    while not(done):
        ...
        songDiff = fontText.render(str(diff),4,(255,255,255))
        backMenu = fontOptions.render("Back to Title Screen",4,(255,255,255))
        restart = fontOptions.render("Retry Song",4,(255,255,255))
        
        percent = fontText.render(str(notePercent)+"% Notes Hit",4,(255,255,255))
        streak = fontText.render("Highest Streak: "+str(highest),4,(255,255,255))

        title = (780,180,250,80)
        dif = (780,200,250,80)
        menu = (780,300,250,80)
        retry = (780,400,250,80)
