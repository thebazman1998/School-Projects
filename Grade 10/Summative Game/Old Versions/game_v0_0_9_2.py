...
def songSelect():
    ...
    location1 = (500,200,150,100)
    select = location1
    done = False
    g = 0
    backSong, beat, bpm = 0, 0, 0
    ...
    if select == location1:
        ...
        bpm = 60
        beat = 4
    elif select == location3:
        backSong = "3"
        bpm = 60
        beat = 4
        
    return [backSong, beat, bpm]
...
def diffSelect():
    ...
    while not(done):
        ...
        diff1 = font.render("Medium",4,(255,255,255))
        diff2 = font.render("Hard",4,(255,255,255))
        
        location1 = (500,200,100,100)
        location2 = (500,350,100,100)
...
def main():
    ...
    diffSong = diffSelect()
    song = songSelect()
    backSong, maxBeat, bpm = song[0], song[1], song[2]
