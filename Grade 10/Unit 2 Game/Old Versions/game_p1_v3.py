...
def play():
    ...
    while True:
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_SPACE:
                    ...
                    while loop == 1:
                        ...
                        if p2 > 0:
                            screen.blit(boardmg2,boardmg2Box)
        ...
        if p1 > 0:
            boardmg2 = pygame.image.load('Graphics/Health Bar/Health Bar '+ str(p2) + '.gif')
            boardmg2 = pygame.transform.flip(boardmg2,1,0)
            boardmg2 = pygame.transform.scale(boardmg2, (600, 100))
        
        boardmg2Box = pygame.Rect((660,10),(1,1))
        ...
        if p2 > 0:
            ...
            if player2.bottom == 700:
                jump2 = False
                move2Down = False
            if move2Up and player2.top > 0 and not(punch or kick):
                if player2.top < 240:
                    move2Up = False
                    move2Down = True
                else:
        ...
        # Take Damage
        if p2 > 0:
            if not(kick or punch or moveUp):
        ...
        if not(kick2 or punch2 or moveDown):
            p1 -= dmg1
            dmg1 = 0
