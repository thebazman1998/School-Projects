...
def play():
    ...
    stun = (tapLeft or tapRight or knockLeft or knockRight or downLeft or downRight or fallLeft or fallRight)
    ...
    stun2 = (tap2Left or tap2Right or knock2Left or knock2Right or down2Left or down2Right or fall2Left or fall2Right)
    ...
    while True:
        ...
        if p2 > 0:
            if move2Up or move2Down or punch2:
                ...
                player2StretchedImage = pygame.transform.scale(player2Image, (pWid+40, pHei+20))
            elif jump2:
                player2StretchedImage = pygame.transform.scale(player2Image, (pWid+15, pHei+20))
            else:
                player2StretchedImage = pygame.transform.scale(player2Image, (pWid, pHei))
        ...
        if p2 > 0:
            if player2.bottom == 700:
                if crouching2:
                    ...
                    if punch2Count < 4:
                        p2BoxVul = pygame.Rect((player2.left+(pWid/3),player2.top),((2*pWid)/3,pHei))
                    else:
                        p2BoxVul = pygame.Rect((player2.left+(pWid/4),player2.top),((5*pWid)/7,pHei))
                elif kick2:
                    if kick2Count < 5 and kick2Count > 0:
                        if p1BoxVul.right < p2BoxVul.left:
                            p2BoxVul = pygame.Rect((player2.left+((3*pWid)/4)+20,player2.top),((5*pWid)/6-20,pHei))
                        else:
                            p2BoxVul = pygame.Rect((player2.left-(pWid/8)+30,player2.top),((5*pWid)/6-30,pHei))
                else:
                    if (p1BoxVul.right+p1BoxVul.left) < (p2BoxVul.left+p2BoxVul.right):
            ...
            if punch2:
                ...
                if (p2BoxVul.right+p2BoxVul.left) < (p1BoxVul.left+p1BoxVul.right):
                    if kick2Count == 2 or kick2Count == 3:
                        p2BoxAtt = pygame.Rect((player2.left+110,player2.bottom-80),((9*(basic2.left-basic2.right))/10,80))
                    else:
        ...
        # Take Damage
        if p2 > 0:
            if not(kick or punch or moveUp or stun):
                ...
                if kick:
                    if p1BoxAtt.colliderect(p2BoxVul) or p2BoxVul.colliderect(p1BoxAtt):
                        if (p1BoxAtt.left-p1BoxAtt.right)/2 < (p2BoxAtt.left-p2BoxAtt.right)/2:
                            knock2Right = True
                        else:
                            knock2Left = True
                        dmg2 += 10
        ...
        if p1 > 0:
            if not(kick2 or punch2 or move2Up or stun2):
