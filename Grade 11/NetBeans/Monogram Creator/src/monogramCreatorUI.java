 ...
 * @author Basil
 */
public class monogramCreatorUI extends javax.swing.JFrame {

    /**
     * Creates new form monogramCreatorUI
     */
    public monogramCreatorUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        monogramLabel.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        monogramLabel.setForeground(new java.awt.Color(255, 0, 0));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(93, 93, 93)
                                .addComponent(monogramLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(createButton)
                    .addComponent(monogramLabel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
    ...
    private void createButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_createButtonMouseClicked
        ...
        String monogram = firstName.substring(0, 1).toLowerCase() + lastName.substring(0, 1).toUpperCase() + middleName.substring(0, 1).toLowerCase();
        
        monogramLabel.setText(monogram);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(monogramCreatorUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new monogramCreatorUI().setVisible(true);
            }
        });
    }
